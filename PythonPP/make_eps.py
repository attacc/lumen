...
parser.add_argument('-t', help="temperature(default 0.0 K)",type=float , default=0.0, dest="temp")
parser.add_argument('-gap', help="gap for the Bose",type=float , default=-1.0, dest="gap")
